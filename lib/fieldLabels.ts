export const fieldLabels: Record<string, string> = {
  ...
  opexComponent: "汚水処理費（維持管理費分）",
  capitalCostComponent: "汚水処理費（資本費分）",
  operatingRevenue: "営業収益",
  operatingExpense: "営業費用",
  ordinaryRevenue: "経常収益",
  ordinaryExpense: "経常費用",
  ordinaryProfitLoss: "経常損益",
  netIncome: "当年度純損益",
  accumulatedDeficit: "累積欠損金",
  totalRevenueNonLegal: "総収益",
  totalExpenseNonLegal: "総費用",
  realBalance: "実質収支",
  revenueExpenditureRatio: "収益的収支比率",
  generalAccountTransfer: "一般会計繰入金（法非適用）",
...
export const unitLabels: Record<string, string> = {
  ...
  people: "人",
  percent: "%",
  yen_per_month_tax_included: "円／月（税込）"
};
